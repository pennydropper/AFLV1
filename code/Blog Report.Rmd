...
```{r fig.width=13, fig.height=6, echo=TRUE}
...
act.with.pred(afl.results, optim.by) %>%
  ...
  geom_bar(stat = "count", aes(fill = act.hm), colour = "#737373", binwidth = 0.1) +
